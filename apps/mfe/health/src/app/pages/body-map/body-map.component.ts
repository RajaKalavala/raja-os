  ...
  template: `
    <div class="body-map-page">
      <div class="page-header">
        <h1>Body Map</h1>
        <p class="subtitle">Interactive view of your health data by body system</p>
      </div>
      <div class="placeholder-card">
        <p>Explore health data mapped to body regions.</p>
        <p class="hint">Phase 3 — Interactive SVG body diagram with hotspot regions</p>
      </div>
    </div>
  `,
  styles: [`
    .body-map-page { max-width: 1200px; margin: 0 auto; }
    .page-header {
      margin-bottom: 24px;
